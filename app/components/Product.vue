  ...
  >
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetails">
        ...
        <span class="px-1 relative text-xs font-semibold -top-1.5 text-]#FF6674">
          Extra 5% off
        </span>

        <div class="flex items-center gap-1 px-1 relative -top-1">
          <span class="text-white font-semibold px-1 5 rounded-sm bg-[#FD374F] text-[9px]">
            Welcome Deal
          </span>
          <span
            class="border text-[#C08562] bg-[#F5F5F%] text-[9px] font-semibold px-1.5 rounded-sm"
          >
            Top Selling
          </span>
        </div>
